    ...
    <div className={styles.bottomBar}>
      <div className='container'>
        <div className='row align-items-center justify-content-between'>
          <div className='col-sm-12 col-lg-3 text-center text-lg-left '></div>
          <div
            className={'col-sm-6 col-lg-3 text-left text-lg-center ' + styles.copyright}
          >
            <p>©Copyright 2016 Bazar | All Rights Reserved</p>
          </div>
          <div className={'col-sm-6 col-lg-3 text-right ' + styles.socialMedia}>
            <ul>
              <li>
                <a href='#'>
